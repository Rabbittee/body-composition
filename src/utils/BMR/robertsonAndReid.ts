...
export const calcRobertsonAndReidLow = formulaGuard(fn(Estimate.Low));
export const calcRobertsonAndReidMean = formulaGuard(fn(Estimate.Mean));
export const calcRobertsonAndReidHigh = formulaGuard(fn(Estimate.High));
